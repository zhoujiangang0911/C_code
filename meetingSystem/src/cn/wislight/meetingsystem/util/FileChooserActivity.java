...
import cn.wislight.meetingsystem.util.FileChooserAdapter.FileInfo;
...
public class FileChooserActivity extends BaseActivity {
	...
	private AdapterView.OnItemClickListener mItemClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> adapterView, View view, int position,
			...
			else {  //是ppt文件 ， 则将该路径通知给调用者
			    Intent intent = new Intent();
			    intent.putExtra(Constants.EXTRA_FILE_CHOOSER , fileInfo.getFilePath());

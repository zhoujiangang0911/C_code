...
public class ConfScheduleListAdapter extends BaseAdapter {
	private Context mcontext;
	private LayoutInflater mInflater;
	private List<Map<String, Object>> data;

	public ConfScheduleListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(
					R.layout.conference_schedule_list_item, null);

			holder = new ViewHolder();
			// 根据自定义的Item布局加载布局
			holder.title = (TextView) convertView
					.findViewById(R.id.conference_common_list_item_title);
			holder.address = (TextView) convertView
					.findViewById(R.id.conference_common_list_item_address);
			holder.remark = (TextView) convertView
					.findViewById(R.id.conference_common_list_item_remark);
			holder.time = (TextView) convertView
					.findViewById(R.id.conference_common_list_item_time);

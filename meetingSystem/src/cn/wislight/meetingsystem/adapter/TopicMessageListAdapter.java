...
public class TopicMessageListAdapter extends BaseAdapter {
	private Context mContext;
	private LayoutInflater mInflater;
	private List<Map<String,String>> data;
	private String myName;
	public TopicMessageListAdapter(Context mcontext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=mInflater.inflate(R.layout.topic_message_list_item, null);

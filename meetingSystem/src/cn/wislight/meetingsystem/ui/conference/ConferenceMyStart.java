 ...
 *    我发起的会议
  */
public class ConferenceMyStart extends BaseActivity {
	...
	public void initView() {
		...
		String url = "MeetingManage/mobile/findMyStartMeeting.action";
		...
		MeetingSystemClient.get(url, null, new AsyncHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
				...
				Toast.makeText(ConferenceMyStart.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				if (response.contains("用户未登陆")){
					Toast.makeText(ConferenceMyStart.this, getString(R.string.error_login), Toast.LENGTH_SHORT).show();
					return;
				}	
				...
				ConfCommonListAdapter adapter = new ConfCommonListAdapter(ConferenceMyStart.this);
				...
				try {
					...
					e.printStackTrace();
					Toast.makeText(ConferenceMyStart.this, getString(R.string.error_dataabout), Toast.LENGTH_SHORT).show();
					Intent data=new Intent();  
				...
				listView.setOnItemClickListener(new OnItemClickListener(){					 
		            ...
		            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
		                ...
		                IntentUtil.startActivity(ConferenceMyStart.this, ConfMystartDetailActivity.class,  data);
		            }
		        });		
	...
	public void setupView() {
		...
		txTitle.setText(getString(R.string.conference_history));

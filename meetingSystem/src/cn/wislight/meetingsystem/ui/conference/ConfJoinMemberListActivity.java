...
public class ConfJoinMemberListActivity extends BaseActivity {
	...
	public void initView() {
		...
		String url = "MeetingManage/mobile/findMeetPersonByMeetNo.action?meetId="+ meetingId;
		...
		MeetingSystemClient.get(url, null, new AsyncHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				Toast.makeText(ConfJoinMemberListActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				if (response.contains("用户未登陆")){
					Toast.makeText(ConfJoinMemberListActivity.this, getString(R.string.error_login), Toast.LENGTH_SHORT).show();
					return;
				}	
				...
				ConfJoinMemberAdapter adapter = new ConfJoinMemberAdapter(ConfJoinMemberListActivity.this);
				...
				try {
					...
					e.printStackTrace();
					Toast.makeText(ConfJoinMemberListActivity.this, getString(R.string.error_dataabout), Toast.LENGTH_SHORT).show();

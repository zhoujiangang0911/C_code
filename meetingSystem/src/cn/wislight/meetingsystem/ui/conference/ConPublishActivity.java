 ...
 *	会议发布
 */
public class ConPublishActivity extends BaseActivity {
	...
	public void initView() {
		...
		String url = "MeetingManage/mobile/getMyVerifyMeetingList.action?type=1";
		...
		MeetingSystemClient.get(url, null, new AsyncHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
				...
				Toast.makeText(ConPublishActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				if (response.contains("用户未登陆")){
					Toast.makeText(ConPublishActivity.this, getString(R.string.error_login), Toast.LENGTH_SHORT).show();
					return;
				}	
				...
				ConfCommonListAdapter adapter = new ConfCommonListAdapter(ConPublishActivity.this);
				...
				try {
					...
					e.printStackTrace();
					Toast.makeText(ConPublishActivity.this, getString(R.string.error_dataabout), Toast.LENGTH_SHORT).show();
					Intent data=new Intent();  
				...
				listView.setOnItemClickListener(new OnItemClickListener(){					 
		            ...
		            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
		                ...
		                IntentUtil.startActivity(ConPublishActivity.this, ConfPublishDetailActivity.class,  data);
		            }
		        });		
	...
	public void setupView() {
		...
		txTitle.setText(getString(R.string.conference_publish));
	}
}

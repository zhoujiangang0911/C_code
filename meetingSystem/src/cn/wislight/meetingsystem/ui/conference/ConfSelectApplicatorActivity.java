...
public class ConfSelectApplicatorActivity extends BaseActivity {
	...
	public void initView() {
        ...
        String pplType = getIntent().getStringExtra("type");  
		String url = "MeetingManage/mobile/findRecordList.action?ppltype=" + pplType;
		MeetingSystemClient.get(url, null, new AsyncHttpResponseHandler(){

			@Override
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				Toast.makeText(ConfSelectApplicatorActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				if (response.contains("用户未登陆")){
					Toast.makeText(ConfSelectApplicatorActivity.this, getString(R.string.error_login), Toast.LENGTH_SHORT).show();
					return;
				}	
				applicator_listview.setVisibility(View.VISIBLE);		
				loading.setVisibility(View.GONE);
				
				ConfSelectApplicatorAdapter adapter = new ConfSelectApplicatorAdapter(ConfSelectApplicatorActivity.this);
				...
				try {
					...
					e.printStackTrace();
					Toast.makeText(ConfSelectApplicatorActivity.this, getString(R.string.error_dataabout), Toast.LENGTH_SHORT).show();
					Intent data=new Intent();  

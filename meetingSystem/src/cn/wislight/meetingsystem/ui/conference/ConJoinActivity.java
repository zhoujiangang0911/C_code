...
import cn.wislight.meetingsystem.adapter.ConfScheduleListAdapter;
 ...
 *  待我参加
 */
public class ConJoinActivity extends BaseActivity {
	...
	public void initView() {
		...
		String url = "MeetingManage/mobile/getMeetingScheduleList.action";
		...
		MeetingSystemClient.get(url, null, new AsyncHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
				...
				Toast.makeText(ConJoinActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				ConfScheduleListAdapter adapter = new ConfScheduleListAdapter(ConJoinActivity.this);
				...
				try {
					...
					e.printStackTrace();
					Toast.makeText(ConJoinActivity.this, getString(R.string.error_dataabout), Toast.LENGTH_SHORT).show();
					Intent data=new Intent();  
				...
				listView.setOnItemClickListener(new OnItemClickListener(){					 
		            ...
		            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
		                ...
		                IntentUtil.startActivity(ConJoinActivity.this, ConfJoinDetailActivity.class,  data);
		            }
		        });		
			}
		});		
	...
	public void setupView() {
		...
		txTitle.setText(getString(R.string.conference_schedule));
	}

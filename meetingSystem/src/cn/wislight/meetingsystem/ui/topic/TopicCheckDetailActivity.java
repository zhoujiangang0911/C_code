 ...
 */
public class TopicCheckDetailActivity extends BaseActivity {
	...
	public void clickRefuse(View view) {
		...
		{
			Toast.makeText(TopicCheckDetailActivity.this,
	...
	public void clickAttachmentList(View view){
        ...
        IntentUtil.startActivity(TopicCheckDetailActivity.this, AttachmentListActivity.class,  data);
	}
		...
		MeetingSystemClient.get(url, null, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				if (response.contains("用户未登陆")){
					Toast.makeText(TopicCheckDetailActivity.this, getString(R.string.error_login), Toast.LENGTH_SHORT).show();
					return;
				}	
				if (response.contains("success")){
					Toast.makeText(TopicCheckDetailActivity.this, getString(R.string.result_success), Toast.LENGTH_SHORT).show();
					finish();
					Intent intent = new Intent();    
					intent.setClass((Context)TopicCheckDetailActivity.this, TopicStayActivity.class);
					intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);   
					startActivity(intent);  
				}else{
					Toast.makeText(TopicCheckDetailActivity.this, getString(R.string.error_upload_failed), Toast.LENGTH_SHORT).show();
				}
			}
		});

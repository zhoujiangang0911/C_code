 ...
 *
 */
public class UserCommonlyBusinessmanDetailActivity extends BaseActivity implements OnClickListener{
	...
	public void fillData(String commonlypersonId){		
		String url = "publicservice/commonlybusinessman_detail.htm?json=true&commonlyperson.id="+commonlypersonId;
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				// loadingdiag.hide();
				Toast.makeText(UserCommonlyBusinessmanDetailActivity.this,
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					if (result.equals("success")){
						...
						Toast.makeText(UserCommonlyBusinessmanDetailActivity.this,"未查询到信息", Toast.LENGTH_SHORT)
								.show();
					}
	...
	public void deleteCommonlyPerson(String commonlypersonId){
		String url = "publicservice/commonlybusinessman_delete.htm?json=true&commonlyperson.id="+commonlypersonId;
		System.out.println("wangting:"+url);
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(UserCommonlyBusinessmanDetailActivity.this,"取消常用联系人成功", Toast.LENGTH_SHORT)
						.show();
						finish();				
					}else {
						Toast.makeText(UserCommonlyBusinessmanDetailActivity.this,"取消常用联系人失败", Toast.LENGTH_SHORT)
								.show();
					}

...
public class CompleteHandleActivity extends BaseActivity {
	...
	public void setUpView() {
    	...
    	listviewQiangdaode.setOnItemClickListener(new OnItemClickListener(){	 
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                    long arg3) {
                Intent data=new Intent(CompleteHandleActivity.this, DetailNegotiateForSenderActivity.class);  
	...
	public void fillNegotiationData() {
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				// loadingdiag.hide();
				Toast.makeText(CompleteHandleActivity.this,

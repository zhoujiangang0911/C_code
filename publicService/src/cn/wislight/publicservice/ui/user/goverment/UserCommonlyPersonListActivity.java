...
public class UserCommonlyPersonListActivity extends BaseActivity {
	private List datalist;
	private UserCommonlyPersonListAdapter adapter;
	...
	public void setUpView() {
		...
		adapter = new UserCommonlyPersonListAdapter(this);
    	...
    	listview.setOnItemClickListener(new OnItemClickListener(){	 
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                    long arg3) {
                Intent data=new Intent(UserCommonlyPersonListActivity.this, UserCommonlyPersonDetailActivity.class);  
	...
	private void fillData(){
		String url ="publicservice/commonlyperson_findCommonlyPersonList.htm?json=true";
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler(){
			@Override
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				//loadingdiag.hide();
				Toast.makeText(UserCommonlyPersonListActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			}

 ...
 *
 */
public class UserHandlingGovermentAffairActivity extends BaseActivity {
	...
	public void setUpView() {
		setContentView(R.layout.activity_user_handling_govermentaffair);
    	...
    	listview.setOnItemClickListener(new OnItemClickListener(){	 
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                    long arg3) {
                Intent data=new Intent(UserHandlingGovermentAffairActivity.this, UserHandlingGovermentAffairDetailActivity.class);  
	...
	private void fillData(){
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				//loadingdiag.hide();
				Toast.makeText(UserHandlingGovermentAffairActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			}

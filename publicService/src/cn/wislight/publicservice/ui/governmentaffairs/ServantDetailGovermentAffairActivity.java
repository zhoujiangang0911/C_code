 ...
 *
 */
public class ServantDetailGovermentAffairActivity extends BaseActivity implements OnClickListener{
	...
	public void setUpView() {
		setContentView(R.layout.activity_servant_detail_govermentaffair);
		...
		txtBusinessaffairSenderPhone = (TextView) findViewById(R.id.tv_phone);
	...
	public void fillData(String govermentAffairId){		
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				// loadingdiag.hide();
				Toast.makeText(ServantDetailGovermentAffairActivity.this,
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					if (result.equals("success")){
						...
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"初始化失败", Toast.LENGTH_SHORT)
								.show();
					}
	...
	public void onClick(View v) {
		...
		case R.id.imageBtn_callphone:
			Toast.makeText(getApplicationContext(), ""+"tel:"+txtBusinessaffairSenderPhone.getText(), Toast.LENGTH_LONG).show();
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"接受事务成功", Toast.LENGTH_SHORT)
						.show();											
					}else {
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"接受事务失败", Toast.LENGTH_SHORT)
								.show();
					}
					finish();
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"完成事务成功", Toast.LENGTH_SHORT)
						.show();											
					}else {
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"完成事务失败", Toast.LENGTH_SHORT)
								.show();
					}
					finish();
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"归档事务成功", Toast.LENGTH_SHORT)
						.show();											
					}else {
						Toast.makeText(ServantDetailGovermentAffairActivity.this,"归档事务失败", Toast.LENGTH_SHORT)
								.show();
					}
					finish();
				} catch (JSONException e) {

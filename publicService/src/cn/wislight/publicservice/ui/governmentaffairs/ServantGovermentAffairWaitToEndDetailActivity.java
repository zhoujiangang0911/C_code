 ...
 *
 */
public class ServantGovermentAffairWaitToEndDetailActivity extends BaseActivity implements OnClickListener{
	...
	public void setUpView() {
		setContentView(R.layout.activity_servant_waitto_end_detail);
	...
	public void fillData(String govermentAffairId){		
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				// loadingdiag.hide();
				Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					if (result.equals("success")){
						...
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"初始化失败", Toast.LENGTH_SHORT)
								.show();
					}
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"接受事务成功", Toast.LENGTH_SHORT)
						.show();											
					}else {
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"接受事务失败", Toast.LENGTH_SHORT)
								.show();
					}
					finish();
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"完成事务成功", Toast.LENGTH_SHORT)
						.show();											
					}else {
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"完成事务失败", Toast.LENGTH_SHORT)
								.show();
					}
					finish();
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {		
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					String result = jsonObject.getString("result");
					if (result.equals("success")){
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"归档事务成功", Toast.LENGTH_SHORT)
						.show();											
					}else {
						Toast.makeText(ServantGovermentAffairWaitToEndDetailActivity.this,"归档事务失败", Toast.LENGTH_SHORT)
								.show();
					}
					finish();
				} catch (JSONException e) {

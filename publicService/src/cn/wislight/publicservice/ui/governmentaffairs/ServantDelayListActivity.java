 ...
 *
 */
public class ServantDelayListActivity extends BaseActivity {
	...
	public void setUpView() {
		setContentView(R.layout.activity_servant_delay_list);
		
		listview = (ListView) this.findViewById(R.id.servant_delay_listview);
    	...
    	listview.setOnItemClickListener(new OnItemClickListener(){	 
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                    long arg3) {
                Intent intent=new Intent(ServantDelayListActivity.this, ServantDetailGovermentAffairActivity.class);  
	...
	private void fillData(){
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler(){
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				//loadingdiag.hide();
				Toast.makeText(ServantDelayListActivity.this, getString(R.string.error_network), Toast.LENGTH_SHORT).show();
			}
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {							 
					 ...
					 for(int i=0;i<jsonArray.length();i++){
			              ...
			              // if(state.equals(GovermentAffair.STATE.DRAFT))
			               {
			            	   datalist.add(map);
			               } 
					 }

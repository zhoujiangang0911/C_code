 ...
 *
 */
public class ServantGovermentAffairHasEndListFragment extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, 
		...
		View inflateGoverment = inflater.inflate(
			R.layout.activity_servant_has_end_list,container,false);
	...
	public View setViews(View inflateGoverment) {
		...
		listview = (ListView) inflateGoverment.findViewById(R.id.govermentaffair_has_end_listview);
    	...
    	listview.setOnItemClickListener(new OnItemClickListener(){	 
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                    long arg3) {
                Intent intent=new Intent(getActivity(), ServantGovermentAffairHasEndDetailActivity.class);  
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {							 
					 ...
					 for(int i=0;i<jsonArray.length();i++){
			               ...
			               if(state.equals(GovermentAffair.STATE.YIGUIDANG))
			               {
			            	   datalist.add(map);
			               } 
					 }

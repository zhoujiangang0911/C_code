 ...
 *
 */
public class ServantGovermentAffairFindManagerListActivity extends BaseActivity {
	...
	public void setUpView() {
		...
		managerName = this.getIntent().getStringExtra("managerName");
		
		listview = (ListView) this.findViewById(R.id.manager_listview);
    	...
    	listview.setOnItemClickListener(new OnItemClickListener(){	 
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                intent.putExtra("managerId",   (String) ((Map) datalist.get(arg2)).get("id"));
                intent.putExtra("managerName",   (String) ((Map) datalist.get(arg2)).get("content"));
	...
	public void fillData() {
		String url = "publicservice/publicServiceAction_findManagerList.htm?json=true&user.username="+managerName;
		...
		PublicServiceClient.get(url, null, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, byte[] body,
					Throwable error) {
				// loadingdiag.hide();
				Toast.makeText(ServantGovermentAffairFindManagerListActivity.this,
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] body) {
				...
				try {
					...
					if (result.equals("success")) {
						...
						Toast.makeText(ServantGovermentAffairFindManagerListActivity.this, "初始化失败",

...
public class UserCommonlyPersonListAdapter  extends BaseAdapter{
	private Context mcontext;
	private LayoutInflater mInflater;
	private List<Map<String, Object>> data;
	
	public UserCommonlyPersonListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.immessage.setOnClickListener(new OnClickListener(){	
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub					
				((UserCommonlyPersonListActivity) mcontext).clickIMMessage(mcontext,finalPosition);
			}					
		});	
		holder.callphone.setOnClickListener(new OnClickListener(){	
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub					
				((UserCommonlyPersonListActivity) mcontext).clickCallPhone(mcontext,finalPosition);
			}					
		});	
